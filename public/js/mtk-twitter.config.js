...
const MTK_TWITTER_CONFIG = {
  ...
  uiLabels: {
    ...
    search:        { en:'Search Mwitter',  he:'חיפוש',         ar:'بحث',               hi:'खोजें',       es:'Buscar',         fr:'Rechercher',     de:'Suchen',              zh:'搜索',      pt:'Pesquisar',     ja:'検索',         ru:'Поиск',          ko:'검색',      it:'Cerca'          },
    trending:      { en:'Trending',        he:'טרנדים',         ar:'الرائج',            hi:'ट्रेंडिंग',   es:'Tendencias',     fr:'Tendances',      de:'Trends',              zh:'趋势',      pt:'Tendências',    ja:'トレンド',     ru:'Тренды',         ko:'트렌드',    it:'Tendenze'       },
    trendingMeta:  { en:'Trending',        he:'טרנד',           ar:'رائج',              hi:'ट्रेंड',      es:'Tendencia',      fr:'Tendance',       de:'Trend',               zh:'趋势',      pt:'Tendência',     ja:'トレンド',     ru:'Тренд',          ko:'트렌드',    it:'Tendenza'       },
    posts:         { en:'posts',           he:'פוסטים',         ar:'منشورات',           hi:'पोस्ट',       es:'publicaciones',  fr:'publications',   de:'Beiträge',            zh:'帖子',      pt:'publicações',   ja:'投稿',         ru:'постов',         ko:'게시물',    it:'post'           },
    noPostsYet:    { en:'No posts yet. Be the first!', he:'אין פוסטים עדיין. היה הראשון!', ar:'لا منشورات بعد. كن الأول!', hi:'अभी कोई पोस्ट नहीं। पहले बनें!', es:'Sin publicaciones aún. ¡Sé el primero!', fr:'Aucune publication. Soyez le premier!', de:'Noch keine Beiträge. Sei der Erste!', zh:'还没有帖子。成为第一个！', pt:'Nenhuma publicação ainda. Seja o primeiro!', ja:'まだ投稿がありません。最初に投稿しましょう！', ru:'Нет постов. Будьте первым!', ko:'아직 게시물이 없습니다. 첫 번째가 되세요!', it:'Ancora nessun post. Sii il primo!' },
    newPosts:      { en:'new post',        he:'פוסט חדש',       ar:'منشور جديد',        hi:'नई पोस्ट',    es:'nueva publicación', fr:'nouvelle publication', de:'neuer Beitrag', zh:'新帖子',    pt:'nova publicação',ja:'新しい投稿',   ru:'новый пост',     ko:'새 게시물', it:'nuovo post'     },
    newPostsPlural:{ en:'new posts',       he:'פוסטים חדשים',   ar:'منشورات جديدة',     hi:'नई पोस्ट',    es:'nuevas publicaciones', fr:'nouvelles publications', de:'neue Beiträge', zh:'新帖子',  pt:'novas publicações',ja:'新しい投稿',  ru:'новых постов',   ko:'새 게시물', it:'nuovi post'     },
    reply:         { en:'Reply',           he:'השב',            ar:'رد',                hi:'जवाब दें',    es:'Responder',      fr:'Répondre',       de:'Antworten',           zh:'回复',      pt:'Responder',     ja:'返信',         ru:'Ответить',       ko:'답글',      it:'Rispondi'       },
    signOut:       { en:'Sign Out',        he:'התנתק',          ar:'تسجيل الخروج',      hi:'साइन आउट',    es:'Cerrar sesión',  fr:'Se déconnecter', de:'Abmelden',            zh:'退出',      pt:'Sair',          ja:'サインアウト', ru:'Выйти',          ko:'로그아웃',  it:'Esci'           },
    changeLanguage:{ en:'Change Language', he:'שנה שפה',        ar:'تغيير اللغة',       hi:'भाषा बदलें',  es:'Cambiar idioma', fr:'Changer de langue', de:'Sprache ändern',   zh:'更改语言',  pt:'Mudar idioma',  ja:'言語を変更', ru:'Изменить язык',  ko:'언어 변경', it:'Cambia lingua'  },
